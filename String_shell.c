...
int main(int argc, char* argv[])
{
    ...
    if ((fd_file = open("Commands/String/String_Commands.txt", O_RDWR, 0664)) == -1)
    {
    ...
    while (1)
    {
        printf("StringShell> "); // Display the prompt
        ...
        if (strcmp(args[0], "PrintFile") == 0)
        {
            ...
            pid = CreateNewProcessAndExec("./PrintFile", args); // Execute PrintFile command
        ...
        else if (strcmp(args[0], "Find") == 0)
        {
            ...
            pid = CreateNewProcessAndExec("./Find", args); // Execute Find command
            free(args); // Free args memory
        }
        else if (strcmp(args[0], "Replace") == 0)
        {
            ...
            pid = CreateNewProcessAndExec("./Replace", args); // Execute Replace command
            free(args); // Free args memory
        }
        else if (strcmp(args[0], "History") == 0)
        {
            ...
            // Add space for "String" argument and NULL terminator
            temp = realloc(args, (arg_count + 2) * sizeof(char*));
            if (temp == NULL)
            {
            ...
            // Set "String" argument and NULL terminator
            args[1] = "String";
            args[2] = NULL;
